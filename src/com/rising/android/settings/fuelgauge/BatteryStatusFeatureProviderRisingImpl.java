package com.rising.android.settings.fuelgauge;
...
public class BatteryStatusFeatureProviderRisingImpl extends BatteryStatusFeatureProviderImpl {
    private boolean mAdaptiveChargingEnabledInSettings;
    private AdaptiveChargingManager mAdaptiveChargingManager;

    public BatteryStatusFeatureProviderRisingImpl(Context context) {
        super(context);
