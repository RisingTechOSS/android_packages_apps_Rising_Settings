...
package com.rising.android.settings.gestures;
...
public class RisingGesturesSettingPreferenceController extends GesturesSettingPreferenceController {
    ...
    public RisingGesturesSettingPreferenceController(Context context) {
        super(context);
